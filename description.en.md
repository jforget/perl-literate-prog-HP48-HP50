...
The CVTCAR section will be selected in three files, <tt>ex1</tt>, <tt>ex2</tt> and <tt>ex3</tt>.
On the other hand, it seems that the SUBSG section will be selected
